<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('extended_profile_id'); ?></th>
			<th><?php echo $this->Paginator->sort('username'); ?></th>
			<th><?php echo $this->Paginator->sort('password'); ?></th>
			<th><?php echo $this->Paginator->sort('recovery_hash'); ?></th>
			<th><?php echo $this->Paginator->sort('role'); ?></th>
			<th><?php echo $this->Paginator->sort('email'); ?></th>
			<th><?php echo $this->Paginator->sort('loggedin'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['profile_id']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['extended_profile_id']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['username']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['password']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['recovery_hash']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['role']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['email']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['loggedin']); ?>&nbsp;</td>
